"        SELECT PRF.PRNUM, PRFL.ITEMNO, PRFL.MATID AS PRFMATID, PRFL.MATDESC AS PRFMATDESC,POFL.MACHINEID,POFL.PRODUCTLINEID AS LINE_NO,PRFL.DESCRIPTION AS [BRAND] , PRF.BUDGETTYPE, 
...
AND CAST(PRF.CREATEDDATE As Int) >= '20220101'
AND CAST(PRF.CREATEDDATE As Int) <= '20220131'
