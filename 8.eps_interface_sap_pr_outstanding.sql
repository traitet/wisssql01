...
-- =========================================================
CREATE PROCEDURE [dbo].[eps_interface_sap_pr_outstanding]
...
AS
  SELECT TOP (@record_count )
	...
	WHERE 
        ...
        --AND PRFL.INVESTMENTID = '' AND
        CAST(PRF.CREATEDDATE As Int) >= @start_date AND
        CAST(PRF.CREATEDDATE As Int) <= @end_date AND 
        PRF.PRNUM = @doc_num
